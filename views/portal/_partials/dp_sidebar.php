...
?>
  ...
  <div class="main-sidebar sidebar-style-2" >
    <aside id="sidebar">
        ...
        <a href="<?php echo base_url(); ?>department/dashboard"><img src="<?php echo base_url(); ?>assets/img/ASMS-logo.png" alt="logo" width="150"></a>
        <p style="padding: 4px;">Last Sync:23-01-21 | Time: 02.20 PM</p><hr/>
        <div class="section"></div>

      </div>
          <div class="sidebar-brand sidebar-brand-sm">
          <a href="<?php echo base_url(); ?>department/dashboard">AAFT</a>
          </div>
            <div class="sidebar-brand" style="padding-top: 27px;padding-bottom: 82px;">
              <ul class="navbar-nav" style=" padding: 10px;background: aliceblue;">
            
                  <li class="dropdown">
                    <a href="#" data-toggle="dropdown" class="nav-link">
                        <img alt="image" style=" width: 30px;" src="<?php echo base_url(); ?>assets/img/avatar/avatar-1.png" class="rounded-circle mr-1"> 
                            <div class="d-sm-none d-lg-inline-block"><h6>Kishor Dhakad</h6></div>
                   </a>
                  ...
                  <li class="nav-item active" style="padding: 0px;">
                      <a class="nav-link" href="#"><p style="color: red; text-align: center;">(Department)</p> <span class="sr-only"></span></a>
                  </li>
            
                   <li class="nav-item active" style="padding: 0px;">
                      <a class="nav-link" href="#"><h6>Mobile No. 5655345985</h6> <span class="sr-only"></span></a>
                  </li> 
       ...
       <div class="sidebar-brand">
          ...
          <li><a href="<?php echo base_url(); ?>portal/semester_details" class="nav-link"><i class="fas fa-info-circle"></i><span>Outstanding Fee's</span></a></li>
          <li><a href="<?php echo base_url(); ?>portal/transaction_details" class="nav-link"><i class="fas fa-globe-asia"></i><span>Transaction Details</span></a></li>  -->
          <li style="background:antiquewhite;"><a style="color: black;" href="<?php echo base_url(); ?>department/profile" class="nav-link"><i class="fas fa-user"></i><span>Profile</span></a>

          </li>

          <li style=" color: white;
              background:antiquewhite;"><a style="color: black;" href="<?php echo base_url(); ?>portal/logout" class="nav-link"><i class="fas fa-sign-out-alt"></i><span>Logout</span></a>
          </li>
        </ul>
