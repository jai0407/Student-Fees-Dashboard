            ...
            <div class="sidebar-brand" style="padding-top: 27px;padding-bottom: 82px;">
              <ul class="navbar-nav" style="align-items: flex-start; padding: 10px;background: aliceblue;">
                  ...
                  <li class="dropdown">
                    ...
                    <div class="d-sm-none d-lg-inline-block"><?php echo $userdata[0]['first_name']; ?> <?php echo $userdata[0]['middle_name']; ?> <?php echo $userdata[0]['last_name']; ?></div>
                   </a>
                 </li>
                  ...
                  <li class="nav-item active">
                      <a class="nav-link" href="#"><?php echo 'Student ID: '.$userdata[0]['student_unique_id']; ?> <span class="sr-only"></span></a>
                  </li>
