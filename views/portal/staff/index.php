			...
			<div class="section-body">
				...
				<div class="row">
		            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
		              	<a href="<?php echo base_url(); ?>staff/outstanding_fees">
		            ...
		            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
		              	<a href="<?php echo base_url(); ?>staff/fee_paid">
		              		<div class="card card-statistic-1">
				              
				                <div class="card-wrap bg-danger">
				                  	<div class="card-header" style="padding-bottom: 40px;padding-top: 40px;">
				                   		<h4 style="font-size: 17px;text-align: center; color: white;">Fees Paid & Receipt</h4>
				                  	</div>
				                </div>
		              		</div>
		              	</a>
