                          ...
                          <!--   <th>Semester Details</th> -->
                           ...
                           <!--  <th>Exam Fees</th>
                            ...
                            <th>Action</th>
                                          ...
                                          <tbody>
                                                <?php
                                                if (!empty($semester_fee_tbl)) {
                                                    foreach ($semester_fee_tbl as $semester_fee) : ?>
                                                     <tr>
                                                            <td>
                                                                <?php
                                                                echo $semester_fee->student_id;
                                                                ?>
                                                            </td>  
                                                             <td>
                                                                <?php
                                                                echo $semester_fee->student_course;
                                                                ?>
                                                            </td>
                                                             <td>
                                                                <?php
                                                                echo $semester_fee->student_semester;
                                                                ?>
                                                            </td>
                                                             <td>
                                                                <?php
                                                                echo $semester_fee->tution_fee;
                                                                ?>
                                                            </td>
                                                             <td>
                                                                <?php
                                                                echo $semester_fee->mess_fee;
                                                                ?>
                                                            </td>
                                                             <td>
                                                                <?php
                                                                echo $semester_fee->hostel_fee;
                                                                ?>
                                                            </td>
                                                        
                                                             <td>
                                                                <?php
                                                                echo $semester_fee->medical_insurance_fee;
                                                                ?>
                                                            </td>
                                                               <td>
                                                                <?php
                                                                 $date = $semester_fee->payment_date;
                                                                 echo date("d F, Y", strtotime($date));
                                                                ?>
                                                            </td>
                                                       <!--       <td>
                                                                <?php
                                                                //echo $semester_fee->payment_status;
                                                                ?>
                                                            </td>  -->  
