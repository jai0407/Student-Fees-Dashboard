		...
		<div id="page_1">
			<div id="id1_1">
				...
				<table>
					...
					<tr>
						<td colspan="8"><p>Received with thanks from Mr/Mrs <?php echo $user['first_name'];?> Roll Number <?php echo trim($user['roll_number']); ?>, towards Fee for <span><?php echo $user['course'];?>, 2019-2021</span></p></td>
					</tr>
				</table>
				<table border="1" style="border-collapse: collapse;">
					...
					<tr>
						...
						<td colspan="2">Installment No :1</td>
