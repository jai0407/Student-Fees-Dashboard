<HTML>
	<HEAD>
		...
		<style type="text/css">
			...
			#page_1 {position:relative; overflow: hidden;margin: auto;padding: 0px;border: none;width: 793px;}
			#page_1 #id1_1 {border:none;margin: 70px 0px 0px 0px;padding: 0px;border:none;width: 793px;overflow: hidden;}
			table{
				width: 100%;
			}
			table tr td{
	...
	<?php
		...
		<div id="page_1">
			<div id="id1_1">
				<div class="p0 ft0" style="margin-bottom: 10px;">
				...
				<table>
					...
					<tr>
						<td colspan="8"><p>Received with thanks from Mr/Mrs <?php echo $user['first_name'];?> Roll No. <?php echo $user['roll_number']?>, <?php if($user['father_name']){ echo "Son of Mr /Mrs ".$user['father_name']; } ?> towards Fee for <span><?=$user['course'];?>, <?=($invoice['student_session'])? $invoice['student_session'] :'2019-2021';?></span></p></td>
					</tr>
				</table>
