...
class Department extends CI_Controller
{
    ...
    public function dashboard()
    {
        ...
        $this->load->view('portal/department/index'); 
    }
      public function outstanding_fees()
    {
        if ($this->session->userdata('user_sassion')) {
            ...
            $this->load->view('portal/department/outstanding-fees', $data);
        } else {
            redirect(site_url());
        }
    }
    ...
    public function fee_paid()
    {
        if ($this->session->userdata('user_sassion')) {
            ...
            $this->load->view('portal/department/fee-paid', $data);
        } else {
            redirect(site_url());
        }
    }
      ...
      public function profile()
    {
        ...
        //     $data = array( 'title' => "Profile", 'userdata' => $userdata );
            $this->load->view('portal/department/dp-profile');
        // } else {
        //     redirect(site_url());
        // }
    }
